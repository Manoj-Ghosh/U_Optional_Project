...
urlpatterns = [
    ...
    path('<slug:meetup_slug>', views.meetup_details, name='meetup-detail') #our-domain.com/meetups/<dynamic-path-section>
...
#     path('meetups/<slug:meetup_slug>', views.meetup_details, name='meetup-detail') #our-domain.com/meetups/<dynamic-path-section>
